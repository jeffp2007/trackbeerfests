...
ActiveRecord::Schema.define(version: 20150819022847) do
  ...
  add_index "beer_supplies", ["beer_id", "event_id"], name: "index_beer_supplies_on_beer_id_and_event_id", unique: true, using: :btree
